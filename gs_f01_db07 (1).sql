...
--
-- Host: localhost
-- Generation Time: 2018 年 10 月 04 日 00:05
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
(4, '岸田舞', 'osg', 'osg', 0, 0),
(5, 'chunriiin', 'chun', 'chun', 1, 0),
(6, 'maimai', 'mai', 'mai', 1, 0),
(7, '管理者', 'kanri', 'kanri', 1, 0),
(8, 'キシダマイ', 'chun', 'chun', 0, 0),
(9, 'キシダマイ', 'aaaaaaaa', 'sssssssss', 0, 0),
(10, 'キシダマイ', 'aaaaaaaa', 'sssssssss', 0, 1),
(11, 'キシダマイ', 'aaa', 'aaa', 1, 0);
